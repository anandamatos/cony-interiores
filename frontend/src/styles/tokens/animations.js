...
export const animations = {
  ...
  transitions: {
    ...
    fast: 'all 0.2s cubic-bezier(0, 0, 0.2, 1)',
    spring: 'all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)',
    colors: 'background-color 0.2s cubic-bezier(0, 0, 0.2, 1), color 0.2s cubic-bezier(0, 0, 0.2, 1), border-color 0.2s cubic-bezier(0, 0, 0.2, 1)',
